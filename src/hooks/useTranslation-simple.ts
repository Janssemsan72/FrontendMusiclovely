  ...
  return {
    t: (key: string) => {
      ...
      const translations: { [key: string]: string } = {
        ...
        'hero.subtitle': 'Crie a música perfeita para seus momentos especiais. Propostas, casamentos, tributos — cada nota criada com amor e entregue em 6h.',
        ...
        'pricing.features.delivery24h': 'Entrega em 6h',
        ...
        'faq.questions.deliveryTimes.answer': 'Nossa entrega é de até 6 horas. Você receberá sua música personalizada no prazo combinado, pronta para compartilhar.',
