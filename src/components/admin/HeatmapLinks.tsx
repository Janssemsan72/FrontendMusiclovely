...
import { ExternalLink, Map, Video, BarChart3, AlertCircle, TrendingUp, MessageSquare } from "lucide-react";
import { useBehaviorAnalytics, type AnalyticsLinks } from "@/hooks/useBehaviorAnalytics";
...
export function HeatmapLinks() {
  ...
  const clarityLinks: Partial<AnalyticsLinks> = data.clarity?.links ?? {};
  const hotjarLinks: Partial<AnalyticsLinks> = data.hotjar?.links ?? {};
