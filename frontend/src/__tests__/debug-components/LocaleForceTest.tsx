...
export default function LocaleForceTest() {
  ...
  const runTests = async () => {
    ...
    for (const test of testRoutes) {
      ...
      const result = {
        ...
        status: (detectedLocale === test.expectedLocale && isLocaleForced) ? 'pass' : 'fail'
      };
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold mb-2">🧪 Teste de Força de Idioma</h1>
        <p className="text-muted-foreground">
          Verifica se as rotas /pt, /en, /es estão forçando o idioma específico corretamente
        </p>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p><strong>Idioma Detectado:</strong> {getCurrentLocale(location.pathname) || 'Nenhum'}</p>
            </div>
            <div>
              <p><strong>Idioma do Contexto:</strong> {locale}</p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Executa testes em todas as rotas com prefixo</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Esperado: {result.expectedLocale} | Atual: {result.actualLocale}
                      </div>
                    </div>
                  </div>
